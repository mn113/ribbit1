...
class Model {
	...
	function __construct() {
		$this->db = new mysqli('localhost', 'martin', 'c4n4l+!', 'Ribbit', "8889");
	}
	...
	// function for checking if a row exists
	...
	public function userForAuth($hash) {
		$query = "SELECT Users.* FROM Users JOIN (SELECT username FROM UserAuth WHERE hash = '" . $hash . "' LIMIT 1) AS UA WHERE Users.username = UA.username LIMIT 1";
